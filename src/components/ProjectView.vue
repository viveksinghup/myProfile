  ...
  >
    ...
    <div class="container">
      <div class="w-full h-24 mt-16 mx-auto pm-content">
        <div class="base-info relative overflow-hidden md:overflow-visible">
          <div class="text-4xl font-serif text-blue">01</div>
          <div class="text-lg text-gray-10 flex items-center">
            <div class="p-1 w-8 h-8 img-block"><Icon name="category" /></div>
            <span class="ml-4">{{
              $props &&
          ...
          >
            {{
              $props && $props.selectedProject && $props.selectedProject.name
            }}
          </div>
          <div class="text-lg text-gray-10 mt-10 md:mt-0 flex items-center">
            ...
            <span class="ml-4"
              >Team:
              {{
                $props && $props.selectedProject && $props.selectedProject.team
              }}</span
            >
          </div>
          <div class="mt-10">
            <a
              class="btn"
              :href="
                $props && $props.selectedProject && $props.selectedProject.link
              "
              target="_blank"
              >Visit Website</a
            >
          ...
          <div class="absolute base-info-bg right-0 bg-lightblue">
            ...
            >
              <li class="overflow-hidden block w-12 h-12 bg-white rounded-full">
                <Icon name="vuejs" />
              </li>
              <li class="overflow-hidden block w-12 h-12 bg-white rounded-full">
                <Icon name="html" />
        ...
        <div class="mx-auto mt-16 mb-20 md:mb-32 md:mt-48 w-full md:w-11/12">
          <div class="text-xl text-gray-10 text-center mb-20">
            {{
              $props && $props.selectedProject && $props.selectedProject.description
            }}
          </div>
          <div class="w-full">
            <img
              class="w-full img"
              :src="
                $props && $props.selectedProject && $props.selectedProject.image
              "
              :alt="
                $props && $props.selectedProject && $props.selectedProject.name
              "
